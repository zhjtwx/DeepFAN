...
class VisionTransformerMul3DMB(BaseBackbone):
    ...
    def __init__(self,
        ...
        _patch_cfg = dict(
            ...
            conv_type='Conv3d',
            patch_num=self.arch_settings['num_heads'],
        ...
        self.fc_vit_cla = nn.Linear(4096, 2)
        self.fc_patch_list = ModuleList()
        for _ in range(9):
            self.fc_patch_list.append(nn.Linear(4096, 64))
    ...
    def forward(self, x):
        ...
        if self.single_model:
            ...
            vit_nodes = [self.fc_patch_list[i](x[:, i, :]) for i in range(9)]
            return vit_cls, vit_nodes
